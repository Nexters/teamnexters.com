...
for idx, row in enumerate(rows[1:]):
    app_name, thumbnail, th, year, team_name, _members, description, ppt, android_link, ios_link, web_link = row
    projects.append({
        "idx": idx,
        "app_name": app_name,
        "thumbnail": thumbnail,
...
for idx, project in enumerate(projects):
    with open(f"./_content/projects/{idx}.json", mode="w", encoding="utf-8") as f:
